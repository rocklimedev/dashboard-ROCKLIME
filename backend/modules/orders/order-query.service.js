...
const { sendErrorResponse } = require("./services/orders.helpers");
const { fetchCommentsWithUsers } = require("./comment.service");

// ──────────────────────────────────────────────────────────────
// Order read/query service — listing, filtering, details, counts.
// Extracted verbatim from the original monolithic order.controller.js.
// ──────────────────────────────────────────────────────────────
