...
INSERT INTO `addresses` (`addressId`, `street`, `city`, `state`, `postalCode`, `country`, `createdAt`, `updatedAt`, `userId`, `customerId`, `status`) VALUES
	...
	('c9017882-d538-480d-9257-6676f105f76e', 'Amritan, 1 Sultanpur Farms Parkriti Marg, Chhattarpur', 'Delhi', 'Delhi', '110007', 'India', '2026-04-24 06:30:37', '2026-04-24 06:30:37', NULL, 'cd70db23-5846-4b4b-9224-7eef7a5d9cae', 'ADDITIONAL'),
