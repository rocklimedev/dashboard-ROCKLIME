...
const ProductListByCategory = ({ isAdmin = false }) => {
    ...
    return (products, customers) => {
      ...
      let filtered = products.filter((product) => {
        ...
        const matchesSearch =
          ...
          (product.product_code?.toString().toLowerCase() || "").includes(
            searchTerm
          ) ||
          (product.company_code?.toString().toLowerCase() || "").includes(
            searchTerm
          );
        ...
        return matchesCreator && matchesBrand && matchesSearch && matchesDate;
      });
    ...
    <section className="page-wrapper">
      <div className="content">
        <div className="banner-container">
          <img
            src={mainWrapper}
            alt={`Products in ${getCategoryName()}`}
            className="banner-image"
          />
          <div className="banner-overlay">
            <h2 className="banner-title">{getCategoryName()}</h2>
            <p className="banner-subtitle">
              Browse our selection of products in {getCategoryName()}.
            </p>
          </div>
        </div>
                    ...
                    <Card
                      ...
                      cover={
                        <div className="product-image-wrapper">
                          <img
                            src={
                              product?.images?.[0] || getFallbackImage(index)
                            }
