          ...
          <div class="d-flex align-items-center justify-content-between">
            <div class="ledger-info mb-4">
              <div class="d-flex align-items-center">
                <a href="profile.html" class="avatar me-2">
                  <img
                ...
                <h2>
                  <a href="profile.html">
                    John Smith
                    <a
                      href="https://kanakku.dreamstechnologies.com/cdn-cgi/l/email-protection#c7ada8afa9b4aaaeb3af87a2bfa6aab7aba2e9a4a8aa"
                      class="d-block mail-to"
                    >
                      <span
                        class="__cf_email__"
                        data-cfemail="650f0a0d0b16080c110d25001d04081509004b060a08"
                      >
                        [email&#160;protected]
                      </span>
                    </a>
                ...
                <li>
                  <div class="closing-balance">
                    <span class="d-flex align-items-center">
                      <i class="fa fa-refresh me-2 text-danger-light"></i>
                      Closing Balance : $400
                    </span>
                  </div>
                </li>
                    ...
                    <table class="table table-stripped table-hover">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>13 Aug 2023</td>
                          <td>
                            <span class="badge bg-success-light">Cash</span>
                          </td>
                          <td>
                            <span class="text-danger-light">-$200</span>
                          </td>
                          <td>
                            <span>$300</span>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <span class="text-danger-light">-$100</span>
                          </td>
                          <td>
                            <span>$400</span>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <span class="text-success-light">+$200</span>
                          </td>
                          <td>
                            <span>$500</span>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <span class="text-success-light">+$500</span>
                          </td>
                          <td>
                            <span>$500</span>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <span class="text-success fw-600">$3000.15</span>
                          </td>
                          <td colspan="2">
