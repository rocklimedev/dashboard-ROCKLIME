...
import StatusTag from "../../components/Assets/StatusTag";
import AssignDeviceForm from "../../components/Assets/AssignDeviceForm";
import ConfigEditor from "../../components/Assets/ConfigEditor";
import DeviceHistoryTimeline from "../../components/Assets/DeviceHistoryTimeline";
        ...
        try {
          ...
          Modal.warning({
            ...
            content: (
              <div>
                <p>
                  This secret is shown once — copy it into the terminal's config
                  now.
                </p>
                <div
                  className="dm-mono"
      ...
      >
        ...
        <Descriptions.Item label="Last heartbeat">
          {device.lastHeartbeatAt
            ? `${dayjs(device.lastHeartbeatAt).fromNow()} (${dayjs(
                device.lastHeartbeatAt,
