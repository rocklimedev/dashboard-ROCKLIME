...
const ProductsList = () => {
  ...
  const [searchTerm, setSearchTerm] = useState(urlSearch); // debounced value used in queries
  ...
  // Sync localSearch when URL search changes (back/forward, reset, etc.)
  useEffect(() => {
  ...
  const handleSearchChange = (e) => {
    ...
    debouncedSetSearch(value); // delayed real filter + URL update
  };
  ...
  // Show spinner in search bar while debouncing
    ...
    <div className="page-wrapper">
      <div className="content">
        ...
        {isLoading ? (
          ...
          <Empty
            description={
              localSearch || priceMin || priceMax || sortField
