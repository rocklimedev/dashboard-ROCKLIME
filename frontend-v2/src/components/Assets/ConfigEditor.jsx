...
export default function ConfigEditor({ device }) {
  ...
  useEffect(() => {
    ...
    form.setFieldsValue({
      ...
      extraJson: Object.keys(extra).length
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      message.success(
        "Configuration pushed — the terminal picks it up on its next poll",
      );
    } catch (err) {
  ...
  return (
    <Form form={form} layout="vertical" style={{ maxWidth: 480 }}>
      ...
      <Form.Item
        ...
        help={
          jsonError ||
          "Any other feature flags or filters, merged with the toggles above"
        }
      >
