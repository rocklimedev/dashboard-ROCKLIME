                ...
                <div class="card">
                  <div class="card-header">
                    <h5 class="card-title d-flex justify-content-between">
                      <span>Profile</span>
                      <a class="btn btn-sm btn-white" href="settings.html">
                        Edit
                      </a>
                    </h5>
                  </div>
                    ...
                    <ul class="list-unstyled mb-0">
                      ...
                      <li>
                        <a
                          ...
                          class="__cf_email__"
                          data-cfemail="bbd8d3dac9d7dec8d3daddd5dec9fbdec3dad6cbd7de95d8d4d6"
                        >
                          [email&#160;protected]
                        </a>
                      </li>
                  ...
                  <div class="card-body card-body-height">
                    <ul class="activity-feed">
                      ...
                      <li class="feed-item">
                        ...
                        <span class="feed-text">
                          <a href="profile.html">Marie Canales</a> has accepted
                          your estimate{" "}
                          <a href="view-estimate.html">#GTR458789</a>
                        </span>
                      </li>
                      <li class="feed-item">
                        ...
                        <span class="feed-text">
                          New expenses added{" "}
                          <a href="expenses.html">"#TR018756</a>
                        </span>
                      </li>
                      <li class="feed-item">
                        <div class="feed-date">Oct 24</div>
                      ...
                      <li class="feed-item">
                        ...
                        <span class="feed-text">
                          <a href="profile.html">Robert Martin</a> gave a review
                          for <a href="product-details.html">"Dell Laptop"</a>
                        </span>
                      </li>
                      <li class="feed-item">
